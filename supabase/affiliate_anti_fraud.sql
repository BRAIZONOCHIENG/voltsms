-- Anti-Fraud Migration (IP + Fingerprinting)

-- 1. Update affiliate_profiles with registration metadata
ALTER TABLE public.affiliate_profiles 
ADD COLUMN IF NOT EXISTS registration_ip TEXT,
ADD COLUMN IF NOT EXISTS registration_fingerprint TEXT;

-- 2. Update auth.users referral linking trigger to check for fraud
...
BEGIN
    ...
    IF referral_code_val IS NOT NULL THEN
        -- Find the referrer profile and their IP/Fingerprint
